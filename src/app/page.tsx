  ...
  const features = [
    {
      ...
      description: "Save hours by automatically shortlisting students based on CGPA, backlogs, and custom criteria set by companies.",
      icon: <Zap className="size-5" />,
    },
    {
      title: "Real-Time Placement Analytics",
      description: "Track drive participation, shortlists, and results with live dashboards for students, companies, and the placement cell.",
      icon: <BarChart className="size-5" />,
    },
    {
      title: "Seamless Student-Company Interaction",
      description: "Enable smooth communication and application flow between students, recruiters, and the placement department.",
      icon: <Users className="size-5" />,
    },
    {
      title: "Secure Document Handling",
      description: "Upload and manage resumes, offer letters, and exam results with enterprise-grade security and privacy compliance.",
      icon: <Shield className="size-5" />,
    },
    {
      title: "ERP & Tool Integration",
      description: "Sync with university ERP for attendance, academic records, and placement event check-ins—all in one ecosystem.",
      icon: <Layers className="size-5" />,
    },
    {
      title: "Dedicated Support & Scalability",
      description: "Rely on 24/7 support with a system designed to scale from a single university to a multi-institute SaaS solution.",
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                The all-in-one platform that connects students, recruiters, and placement cells for a seamless hiring journey.
              </p>
