    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-md w-full space-y-8">
        ...
        <motion.div {...fadeInUp} className="text-center">
          ...
          <p className="text-gray-600">Start your journey to your dream career</p>
        </motion.div>
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-3">
            ...
            >
              <Image src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Google_Favicon_2025.svg" alt="Google Logo" width={20} height={20} className="mr-2" />
              Google
            </Button>
          </div>
        </motion.div>
